...
{{{example url="../render-to-texture.html" }}}
...
{{{example url="../render-to-texture-3-cubes-no-depth-buffer.html" }}}
...
{{{example url="../render-to-texture-3-cubes-with-depth-buffer.html" }}}

Now that we have a depth buffer attached to our framebuffer the inner cubes correctly intersect.

<img class="webgl_center" src="img/cubes-with-depth-buffer.jpg" width="100%" height="100%" />
