...
reading [the articles on image processing](image1.md)
...
<img class="webgl_center" src="img/f-texture.png" />
...
<img class="webgl_center noinvertdark" width="405" src="diagram/texture-coordinates-diagram.svg" />

I loaded the texture into photoshop and looked up the various coordinates in pixels.

<img class="webgl_center" width="256" height="256" src="img/f-texture-pixel-coords.png" />
...
Also it was used similar texture coordinates for the back. And here it is.

{{{example url="../texture-coords-mapped.html" }}}
...
<img class="webgl_center" src="img/mip-low-res-enlarged.png" style="border: 2px solid black;" />
...
<img class="webgl_center noinvertdark nobg" src="img/mipmap-low-res-enlarged.png" />
...
{{{example url="../mips-tri-linear.html" }}}
...
<img class="webgl_center noinvertdark nobg" src="img/different-colored-mips.png" />
...
<img class="webgl_center" src="img/keyboard.jpg" />

Here it is.

{{{example url="../bad-npot.html" }}}
...
<tr><td><img src="img/noodles-01.jpg" /></td><td><img src="img/noodles-02.jpg" /></td></tr>
<tr><td><img src="img/noodles-03.jpg" /></td><td><img src="img/noodles-04.jpg" /></td></tr>
<tr><td><img src="img/noodles-05.jpg" /></td><td><img src="img/noodles-06.jpg" /></td></tr>
</table>
</div>
...
<img class="webgl_center" src="img/noodles.jpg" />
