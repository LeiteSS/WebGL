...
To use 2 or more textures it's pretty simple.  Let's [go back a few lessons to our first shader that
draws a single image](image1.md) and update it for 2
images.
...
<div class="glocal-center"><table class="glocal-center-content"><tr><td><img src="img/leaves.jpg" /> <img src="img/star.jpg" /></td></tr></table></div>

And here's the result if we multiply them together using WebGL.

{{{example url="../2-textures.html" }}}
