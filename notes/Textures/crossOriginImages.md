...
example the article about [image processing](image1.md), the
article about [textures](textures.md) and the article about
[implementing 2d drawImage](DrawImage.md).
...
{{{example url="../cors-permission-bad.html" }}}
...
{{{example url="../cors-permission-good.html" }}}
