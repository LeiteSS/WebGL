...
We'll take the sample from the [last article](textures.md). First we'll change
...
{{{example url="../data-texture-3x2-bad.html" }}}
...
{{{example url="../data-texture-3x2.html" }}}
...
Personally I generally use "pixel" when referring to the elements of a texture without thinking about it. &#x1f607";
</p>
</div>
