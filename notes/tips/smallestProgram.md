...
{{{example url="../simple-scissor.html"}}}
...
Well, points automatically get free [texture coordinates](textures.md). They are available in the fragment
...
[the article on data textures](data-textures.md).
...
{{{example url="../simple-point-w-texture.html"}}}
...
{{{example url="../simple-points.html"}}}
