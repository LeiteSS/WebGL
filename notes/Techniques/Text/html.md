...
when we [covered perspective projection](perspective.md).
...
{{{example url="../div.html" }}}

Of course if you want more text make more divs.

{{{example url="../divs.html" }}}

You can look at the source of that last example to see the
details. One important point is creating, appending and removing HTML elements from the DOM
