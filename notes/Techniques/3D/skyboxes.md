...
test](orthographic.md), can skip drawing pixels it knows will fail
...
<div class="webgl_center"><img src="img/skybox-issues.svg" style="width: 500px"></div>
...
Starting with the [environment map example](webgl-environment-maps.html) we need to
remove all the code related to normals as we're not using them here. Then we
need a quad.
...
{{{example url="../skybox-plus-environment-map.html" }}}

It's common for example to take the code [from computing lighting](spot.md)
