...
To do fog in WebGL, basically what you do is use some kind of depth or distance
...
Let's make a shader that does this. We'll use a textured cube from [the article on textures](textures.md).
...
Recall from the article on [cameras](Cameras.md) that after we apply
...
{{{example url="../fog-depth-based.html" }}}
...
<div class="webgl_center"><img src="img/fog-background-color-mismatch.png"></div>
...
<div class="webgl_center"><img src="img/fog-depth.svg" style="width: 600px;"></div>
...
<div class="webgl_center"><img src="img/fog-distance.svg" style="width: 600px;"></div>
...
{{{example url="../fog-distance-based.html" }}}
...
{{{example url="../fog-distance-exp2.html" }}}
...
{{{example url="../fog-depth-based-gl_FragCoord.html" }}}
