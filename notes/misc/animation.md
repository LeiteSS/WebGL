...
{{{example url="../animation-not-frame-rate-independent.html" }}}
...
{{{diagram url="../animation-frame-rate-issues.html" }}}
...
it is easiest if we get the time in seconds but since the `requestAnimationFrame`
...
Next up <a href="textures.md">how to apply textures</a>.
