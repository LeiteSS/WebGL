...
Here's the example from [the article on animation](animation.ms)
...
<div class="webgl_center"><img src="img/screencapture-398x298.png"></div>
...
See [this article](webgl-and-alpha.md) for a few details.
...
Taking the last example from [the article on animation](animation.md)
...
[render to a texture](render2Texture.md).
