...
be to [render to textures](render2Texture.md)
...
In the [very first article](fundamentals.md) it's mentioned
...
Let's draw our 'F' from [previous articles](perspective.md).

The vertex and fragment shaders are the same as the ones used in the articles on
[orthographic](orthographic.md) and [perspective](perspective.md)
projection.
...
[the article on perspective](perspective.md)
except we're using [our library](fun.md) to keep the code simpler.

{{{example url="../multiple-views-one-view.html"}}}
...
{{{example url="../multiple-views.html"}}}
...
{{{example url="../multiple-views-clear-issue.html"}}}
...
{{{example url="../multiple-views-clear-fixed.html"}}}
...
I made the code above use a [requestAnimationFrame loop](animation.md)
...
the shaders simple. If I added [lighting](spot.md)
...
1. Use a fixed position canvas
   ...
   <img src="img/multi-view-skew.gif" style="border: 1px solid black; width: 266px;" class="webgl_center">
...
2. Move the canvas under the content
   ...
   <img src="img/multi-view-fixed.gif" style="border: 1px solid black; width: 266px;" class="webgl_center">
...
<div class="webgl_center"><img src="img/webgl-pixels.svg" style="width: 500px;"></div>
